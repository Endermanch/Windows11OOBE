(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobesettings-multipage-main.html", {
        init: (element, options) => {
            ...
            let isPrivacySensitiveRegionPromise = requireAsync(['legacy/bridge']).then((result) => {
                return result.legacy_bridge.invoke("CloudExperienceHost.Globalization.GeographicRegion.isPrivacySensitiveRegion");
            }).then((isPrivacySensitiveRegion) => {
                this.isPrivacySensitiveRegion = isPrivacySensitiveRegion;
            });


            return WinJS.Promise.join({ loadCssPromise: loadCssPromise, langAndDirPromise: langAndDirPromise, getLocalizedStringsPromise: getLocalizedStringsPromise, getLearnMoreContentPromise: getLearnMoreContentPromise, isConnectedToNetworkPromise: isConnectedToNetworkPromise, getPersonalityPromise: getPersonalityPromise, isPrivacySensitiveRegionPromise: isPrivacySensitiveRegionPromise });
        },
        error: (e) => {
