...
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobelanguage-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'corejs/knockouthelpers', 'jsCommon/oobe-gesture-manager', 'legacy/bridge', 'legacy/events', 'oobelanguage-vm', 'lib/knockout-winjs'], (ko, KoHelpers, gestureManager, bridge, constants, LanguageViewModel) => {
